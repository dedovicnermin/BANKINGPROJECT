...
class TransferMessageErrorIntegrationTest {
    ...
    private static final String OUTBOUND_TOPIC = TransformerTopicNames.OUTBOUND_TRANSFER_ERRORS;
    ...
    void listenerContainerCantDeserialize_errorHandlerSendsToErrorTopic_test() throws InterruptedException {
        ...
        ConsumerRecord<String, String> record = records.poll(15000, TimeUnit.MILLISECONDS);
